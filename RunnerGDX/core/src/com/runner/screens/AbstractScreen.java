...
public class AbstractScreen implements Screen{
	...
	@Override
	public void hide() {
		Gdx.app.log(RunnerGame.LOG, "Ocultar pantalla " + getName());
		dispose();
	}

	@Override
	public void pause() {
		Gdx.app.log(RunnerGame.LOG, "Ir a pausa en pantalla " + getName());
	}

	@Override
	public void resume() {
		Gdx.app.log(RunnerGame.LOG, "Resumir pantalla " + getName());
	}

	@Override
	public void dispose() {
		Gdx.app.log(RunnerGame.LOG, "Eliminar recursos de pantalla " + getName());
	}
}
